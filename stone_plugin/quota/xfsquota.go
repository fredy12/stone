...
// project ids.
//
func NewXfsQuotaControl(basePath string) (QuotaControl, error) {
	//
	...
	logrus.Debugf("NewXfsQuotaControl(%s): nextProjectID = %d", basePath, q.nextProjectID)
	return &q, nil
}

func (q *XfsQuotaControl) Name() string {
	return QuotaXfs
}

// SetQuota - assign a unique project id to directory and set the quota limits
// for that project id
func (q *XfsQuotaControl) SetQuota(targetPath string, quota *Quota) error {
...
func (q *XfsQuotaControl) GetQuota(targetPath string) (*Quota, error) {
...
func (q *XfsQuotaControl) RemoveQuota(targetPath string) error {
...
func (q *XfsQuotaControl) findNextProjectID(home string) error {
