...
func (s *HTTPServer) ResetServerHandler(handler http.Handler) {
	s.server.Handler = handler
}

func (s *HTTPServer) ResetServerTLSConfig(tlsConfig *tls.Config) {
...
func (s *HTTPServer) Serve() <-chan struct{} {
	...
	if s.server.TLSConfig != nil && !s.server.TLSConfig.InsecureSkipVerify {
